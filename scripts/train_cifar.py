...
Section('training', 'Hyperparameters').params(
    ...
    in_model_save_path=Param(str, 'model save path for in set', required=True),
    out_model_save_path=Param(str, 'model save path for out set', required=True)
)
...
if __name__ == "__main__":
    ...
    ch.save(model_out.state_dict(), config['training.out_model_save_path'])
